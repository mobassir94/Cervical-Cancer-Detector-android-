        ...
        predict.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Toast.makeText(MainActivity.this, "predicted probability(yes): " + String.valueOf(distribution[0]) + "%", Toast.LENGTH_LONG).show();

                    Toast.makeText(MainActivity.this, "predicted probability(no): " + String.valueOf(distribution[1]) + "%", Toast.LENGTH_LONG).show();
